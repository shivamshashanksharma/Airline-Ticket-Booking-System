...
<link rel="stylesheet" type="text/css" href="CSS_home11.css"/>
</head>
<body>
<nav>
...
<% if (session.getAttribute("username") == null)
   { %> 
<div class="login-home"><div class="home">Welcome , you need to login</div></div>
 <% }else  { %>
    <div class="login-home"><div class="home">Welcome ${username}</div></div>
<% } %>
<script>
